...
<div class="row">
    <div class="col-6">
        ...
        <div class="form-group">
            <img src="{{ $row->foto_fasilitas_hotel }}" class="img-fluid w-80" />
        </div>
        <x-input label="Foto" name="foto" type="file" 
        keterangan="Foto Bertipe : png, jpg, jpeg.Dimensi :min width 1000px, min height500px. Ukuran :min 50kb,max 1000kb. "/>
